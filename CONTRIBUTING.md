Contributing to Tarvarus Core
============================

The Tarvarus Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Tarvarus Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/tarvarus-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to tarvarus-qt
...
The following applies to code changes to the Tarvarus Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Tarvarus
Network Protocol consensus changes.

Whether a pull request is merged into Tarvarus Core rests with the project merge
...
Patches that change Tarvarus consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tarvarus consensus, it must have been
...
The project leader is the release manager for each Tarvarus Core release.

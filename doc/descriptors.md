# Support for Output Descriptors in Tarvarus Core

Since Tarvarus Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `tvrs1...` for mainnet or `ttvrs1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Tarvarus Core wallets, a convenience function `combo` is

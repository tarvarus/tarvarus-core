...
bech32_templates = [
  ...
  ('tvrs',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tvrs',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tvrs',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tvrs',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('ttvrs',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttvrs',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttvrs',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttvrs',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('ttvrs',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttvrs',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttvrs',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttvrs',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rtvrs',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rtvrs',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rtvrs',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rtvrs', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('ttvrs',   17, 32, Encoding.BECH32M, False, False, False),
  ('rtvrs',  3,  1, Encoding.BECH32M, False, False, False),
  ('tvrs',   15, 41, Encoding.BECH32M, False, False, False),
  ('ttvrs',    0, 16, Encoding.BECH32,  False, False, False),
  ('rtvrs',  0, 32, Encoding.BECH32,  True,  False, False),
  ('tvrs',    0, 16, Encoding.BECH32,  True,  False, False),
  ('ttvrs',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rtvrs',  0, 20, Encoding.BECH32,  False, False, True),
  ('tvrs',    0, 20, Encoding.BECH32M, False, False, False),
  ('ttvrs',    0, 32, Encoding.BECH32M, False, False, False),
  ('rtvrs',  0, 20, Encoding.BECH32M, False, False, False),
  ('tvrs',    1, 32, Encoding.BECH32,  False, False, False),
  ('ttvrs',    2, 16, Encoding.BECH32,  False, False, False),
  ('rtvrs', 16, 20, Encoding.BECH32,  False, False, False),
]

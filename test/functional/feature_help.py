...
"""Verify that starting tarvarus with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tarvarus with -h for help text")
        ...
        self.log.info("Start tarvarus with -version for version information")
        ...
        self.log.info("Start tarvarusd with -fakearg to make sure it does not start")

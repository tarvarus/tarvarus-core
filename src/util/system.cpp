...
const char * const BITCOIN_CONF_FILENAME = "tarvarus.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tarvarus";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Tarvarus";
#else
    // Unix-like
    return pathRet / ".tarvarus";
#endif
#endif
}

...
{
    const char* pszTimestamp = "Vincint Cannady born 1991 known by the mononym Vincint";
    const CScript genesisOutputScript = CScript() << ParseHex("04d9f0d74a13ed663170aa91420eb3fb3dfd0730dd4c0d977800967152552cf4ec52bb19f229bb15cca58b5d718270c6b68aefc965af1d76bd23c81f46472ab21a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x94a73b5dca93e1193e50b4efc6685a5e365c7e87a557bcba81b10388eb279da8"); 
        ...
        genesis = CreateGenesisBlock(1712275287, 712615, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x94a73b5dca93e1193e50b4efc6685a5e365c7e87a557bcba81b10388eb279da8"));
        assert(genesis.hashMerkleRoot == uint256S("0xb71cae566541788201aa2182803a09bc328030b40881c0b14d33e681a811df55"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x94a73b5dca93e1193e50b4efc6685a5e365c7e87a557bcba81b10388eb279da8")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 94a73b5dca93e1193e50b4efc6685a5e365c7e87a557bcba81b10388eb279da8
            /* nTime    */ 1712275287,
            /* nTxCount */ 0,
            /* dTxRate  */ 0
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x574ee4b9064ec5ef6b782332bb021f0acfa610e91a38c0ddbdaad82bc68c7177"); 
        ...
        genesis = CreateGenesisBlock(1712275448, 586456, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x574ee4b9064ec5ef6b782332bb021f0acfa610e91a38c0ddbdaad82bc68c7177"));
        assert(genesis.hashMerkleRoot == uint256S("0xb71cae566541788201aa2182803a09bc328030b40881c0b14d33e681a811df55"));
        ...
        checkpointData = {
            {
                {0, uint256S("574ee4b9064ec5ef6b782332bb021f0acfa610e91a38c0ddbdaad82bc68c7177")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 574ee4b9064ec5ef6b782332bb021f0acfa610e91a38c0ddbdaad82bc68c7177
            /* nTime    */ 1712275448,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1712275582, 1, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6233c30fe7bacb954311ad93e110127eb8c2bc1a6e595e79f4fe07bc946e4c80"));
        assert(genesis.hashMerkleRoot == uint256S("0xb71cae566541788201aa2182803a09bc328030b40881c0b14d33e681a811df55"));
        ...
        checkpointData = {
            {
                {0, uint256S("6233c30fe7bacb954311ad93e110127eb8c2bc1a6e595e79f4fe07bc946e4c80")},
            }
        };

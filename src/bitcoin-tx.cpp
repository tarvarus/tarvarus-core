...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tarvarus-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tarvarus-tx [options] <hex-tx> [commands]  Update hex-encoded tarvarus transaction\n" +
            "or:     tarvarus-tx [options] -create [commands]   Create hex-encoded tarvarus transaction\n" +
            "\n";
